        ...
        <div class="col-12">
          <nav class="main-nav">
            ...
            <ul class="nav">
              ...
              <!-- Login/Authentication Links -->
              @if (Route::has('login'))
              <ul class=" flex justify-between">
                @auth
                <li>
                  <a href="{{ url('/dashboard') }}" class="flex   text-gray-800 hover:text-gray-600">Dashboard</a>
                </li>
                @else
                <li>
                  <a href="{{ route('login') }}" class=" flex  text-gray-800 hover:text-gray-600">Log in </a>
                </li>
                @if (Route::has('register'))
                <li>
                  <a href="{{ route('register') }}" class=" flex text-gray-800 hover:text-gray-600">Register</a>
                </li>
                @endif
                @endauth
